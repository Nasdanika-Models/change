...
public class ECoreGenChangeProcessorsCapabilityFactory implements CapabilityFactory<TargetRequirement, Object> {
		...
		return CompletableFuture.completedStage(
				Collections.singleton(
						CapabilityProvider.of(
								new EcoreGenChangeProcessorsFactory(requirement.requirement().context()))));
	}

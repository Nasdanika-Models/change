package org.nasdanika.models.change.ecore.tests;
...
import org.nasdanika.models.change.ecore.EcoreGenChangeProcessorsFactory;
 ...
 *
 */
public class TestChangeModelDocGen {
	
	@Test
	public void testGenerateChangeModelDoc() throws IOException, DiagnosticException {
		ProgressMonitor progressMonitor = new NullProgressMonitor(); // new PrintStreamProgressMonitor();
		MutableContext context = Context.EMPTY_CONTEXT.fork();
		Consumer<Diagnostic> diagnosticConsumer = d -> d.dump(System.out, 0);
		List<Function<URI,Action>> actionProviders = new ArrayList<>();		
		EcoreGenChangeProcessorsFactory ecoreGenFamilyProcessorFactory = new EcoreGenChangeProcessorsFactory(context);		
		...
		File output = new File(actionModelsDir, "change.xmi");
		...
		String siteMapDomain = "https://change.models.nasdanika.org";		
